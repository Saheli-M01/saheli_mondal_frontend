...
export function MessageIcon({ className = "w-5 h-5" }) {
  return (
    <svg
      ...
      viewBox="0 0 24 24"
    >
      <path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h24a2 2 0 012 2z" />
...
export function XIcon({ className = "w-5 h-5" }) {
  return (
    <svg className={className} fill="currentColor" viewBox="0 0 24 24">
      <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24h-6.657l-5.223-6.833-5.974 6.833h-3.308l7.671-8.786-8.157-10.714h6.599l4.945 6.373L18.244 2.25h0zM17.002 18.257h2.798L6.822 4.126H5.085l11.917 14.131z" />
    </svg>
  );
}
